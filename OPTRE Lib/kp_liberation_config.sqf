...
GRLIB_surrender_chance = 50;                                            // Chance that enemy infantry will surrender after heavy losses are encountered. (Lorewise Sangheilli would never surrender, but since it's the only reliable way to get intel I haven't lowered the chance to 0.)
