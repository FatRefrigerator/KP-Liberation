...
*/
infantry_units = [
	["OPTRE_UNSC_Marine_Soldier_Rifleman_AR",5,0,0],
	["OPTRE_UNSC_Marine_Soldier_Rifleman_BR",5,0,0],
	["OPTRE_UNSC_Marine_Soldier_Rifleman_AT",5,5,0],
	["OPTRE_UNSC_Marine_Soldier_Corpsman",5,0,0],
	["OPTRE_UNSC_Marine_Soldier_Autorifleman",5,0,0],
	...
	["OPTRE_UNSC_Marine_Soldier_AT_Specialist",5,5,0],
	["OPTRE_UNSC_Marine_Soldier_AA_Specialist",5,5,0],
	["OPTRE_UNSC_Marine_Soldier_Marksman",5,0,0],
	["OPTRE_UNSC_Marine_Soldier_Sniper",5,0,0],
	["OPTRE_UNSC_Navy_Soldier_Olive",5,0,0],                            // Naval Aviator
    ["OPTRE_UNSC_Marine_Soldier_Crewman",5,0,0],
	["OPTRE_UNSC_ODST_Soldier_Scout",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Breacher",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Rifleman_BR",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Rifleman_AT",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Paramedic",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Automatic_Rifleman",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Scout_Sniper",10,0,0],
    ["OPTRE_UNSC_ODST_Soldier_Bullfrog",10,0,0]
];
...
air_vehicles = [
    ...
    ["OPTRE_UNSC_falcon",0,0,100],                                      // Unarmed Falcon
    ["OPTRE_UNSC_falcon_armed",0,200,100],                                  // Armed Falcon
    ["OPTRE_UNSC_falcon_S",0,10,100],                                      // Unarmed Falcon with Doorguns
    ["OPTRE_UNSC_falcon_armed_S",0,210,100],                                // Armed Falcon with Doorguns
    ...
    ["OPTRE_Pelican_armed",0,150,150],                                      // Classic armed Pelican
    ["OPTRE_Pelican_armed_70mm",0,200,150],                                 // Armed Pelican with 70mm autocannon for gunner
    ["OPTRE_Pelican_unarmed_SOCOM",0,0,150],                              // SOCOM Pelican (extra seats in back)
    ["OPTRE_Pelican_armed_SOCOM",0,150,150],                                // SOCOM Pelican (extra seats in back)
