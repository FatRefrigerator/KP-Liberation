...
opfor_team_leader = "SPE_GER_radioman";                                   // Team Leader
...
opfor_mrap = "fow_v_sdkfz_251_camo_ger_heer";                                             // Ifrit
opfor_mrap_armed = "fow_v_sdkfz_251_camo_foliage_ger_heer";                                   // Ifrit (HMG)
...
opfor_battlegroup_vehicles_low_intensity = [
    ...
    "fow_v_sdkfz_251_camo_ger_heer",
    "fow_v_sdkfz_251_camo_ger_heer",
    "SPE_OpelBlitz_Flak38",                                            // ZSU-39 Tigri
    "SPE_PzKpfwIII_J",                                          // MSE-3 Marid
    "SPE_PzKpfwIII_M",                                          // MSE-3 Marid
    "SPE_PzKpfwIII_L",                                         // BTR-K Kamysh
    "SPE_FW190F8",                                              // To-201 Shikra
